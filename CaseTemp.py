#!/usr/bin/env python
# mdax will not support or help you with this script.  Use at own risk.
...
device_folder = glob.glob(base_dir + '28*460*')[0]
...
while True:
        ...
        temp = read_temp()
        data = json.dumps({"version":"1.0.0", "datastreams":[{"id":"Case_Temperature","current_value":temp}]})
        ...
        with open("CaseTempOutput", "a") as f:
            f.write("%s, %s\n" % (timestr, temp))
